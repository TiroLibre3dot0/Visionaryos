  ...
  return (
    <div className="text-white p-6">
      <div className="flex items-center gap-2 mb-6">
        ...
        <h1 className="text-3xl font-bold">EITPanel – Wellness Admin Dashboard</h1>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-zinc-900 rounded-lg p-4 shadow-md border border-zinc-700">
          ...
          <p className="text-sm text-zinc-400 mb-4">
            Open the EIT Home public page for users. This is the starting point of the flow.
          </p>
          <button
            onClick={openEITHome}
